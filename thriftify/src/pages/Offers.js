...
//                 <>
//                   <div className='matches-header text-center'>{item.item}'s Offers</div>
//                   <div class="row" style={{ overflowX: 'auto', whiteSpace: 'nowrap' }}>
//                     {calculatePriceRange(outerIndex).length !== 0 ? (
//                       calculatePriceRange(outerIndex).map((store, innerIndex) => (
//                         <div key={innerIndex} className="col store-item"  style={{ display: 'inline-block' }}>
//                           <div className="row text-center">
//                             <p className="store-name">{store.name}</p>
